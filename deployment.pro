...
isSubcomponent('deploymentview::DV','Node1','others','IV_dump_motion_commands','SYSTEM','interfaceview::IV::dump_motion_commands.others','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','IV_dump_motion_commands','Taste::FunctionName','"dump_motion_commands"','').
isProperty('NIL','APPLIES TO','deploymentview::DV','Node1','others','IV_dump_motion_commands','Taste::APLC_Binding','(reference (x86_partition))','').
...
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_partition','Taste::coordinates','"124948 73120 161029 103831"','').
...
isSubcomponent('deploymentview::DV','Node1','others','x86_linux','PROCESSOR','ocarina_processors_x86::x86.linux','NIL','NIL','').
isProperty('NIL','=>','deploymentview::DV','Node1','others','x86_linux','Taste::coordinates','"120438 64345 165539 108218"','').
...
isProperty('NIL','=>','deploymentview::DV','deploymentview','others','Node1','Taste::coordinates','"114800 51810 171177 114485"','').
